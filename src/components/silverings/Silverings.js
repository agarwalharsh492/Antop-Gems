...
const imgPath = 'https://s3.ap-south-1.amazonaws.com/antopgems.com/silverrings/';

class Silverrings extends React.Component {
  state = {
  ...
  triggerContact = (Product) => {
    window.location.href = `mailto:antopgems@gmail.com?subject=Purchase of ${Product.name} - Silver ring(${Product.id})&body=message%20goes%20here`;
  }
  closeProductModal = () => {
...
export default connect(state => ({}), dispatch => ({ dispatch }))(Silverrings);
